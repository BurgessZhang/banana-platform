 ...
 * @file_name BananaPageUtils.java
 * @description 分页工具类
 * @create 2018-04-18 22:34
 */
public class BananaPageUtils implements Serializable {
     ...
     * @param currPage   当前页数
     */
    public BananaPageUtils(List<?> list, int totalCount, int pageSize, int currPage) {
        this.list = list;
     ...
     * 分页
     */
    public BananaPageUtils(Page<?> page) {
