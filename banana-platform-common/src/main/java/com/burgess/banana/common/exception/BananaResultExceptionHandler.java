...
public class BananaResultExceptionHandler {


    private static final Logger LOGGER = LoggerFactory.getLogger(BananaResultExceptionHandler.class);

    /**
     * 处理自定义异常
     */
    @ExceptionHandler(BananaResultException.class)
    public BananaResult handleRRException(BananaResultException e){
