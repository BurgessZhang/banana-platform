package com.burgess.banana.log.entity;
 ...
 * @package com.burgess.banana.common.entity
 * @file BananaSystemUserEntity.java
 * @time 2018-05-23 16:18
 * @desc 系统用户实体
 */
public class BananaSystemUserEntity implements Serializable {
